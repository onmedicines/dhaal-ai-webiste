  ...
  return (
    <section className="w-full flex items-center justify-center bg-background">
      <div className="w-3/4 max-w-6xl p-6 pt-10">
        ...
        {!previewUrl ? (
          <div
            className="h-[40vh] w-full border-2 border-dashed border-muted-foreground/40 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:bg-muted/30 transition-colors"
          ...
          >
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground">
                Click anywhere to upload a photo
              </p>
              {error && (
