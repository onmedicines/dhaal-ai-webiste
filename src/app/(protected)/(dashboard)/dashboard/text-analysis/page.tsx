...
import {
  FileText, Code, Play, Copy, Download, Star, Shield,
  Zap, BarChart3, Globe, CheckCircle, AlertCircle,
  Book, Terminal, Sparkles, Brain, Target, Lock,
  Clock, Users, ArrowRight, ExternalLink, Settings
} from 'lucide-react';
...
public class TextAnalysisExample {
  ...
  const analyzeText = async () => {
    ...
    const mockResult: AnalysisResult = {
      ...
      entities: [
        { text: 'customer service', type: 'SERVICE', confidence: 0.95, start: 10, end: 26 },
        { text: 'product quality', type: 'ATTRIBUTE', confidence: 0.88, start: 45, end: 59 }
      ],
      keywords: [
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="text-left space-y-4">
        <div className="flex items-center gap-3">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Text Analysis SDK</h1>
          </div>
        </div>
      </div>
    ...
    <Card>
      ...
      <CardContent>
        <p className="text-muted-foreground mb-4">
          Advanced sentiment detection with confidence scores and emotion analysis
        </p>
...
<CardContent>
    ...
    <div className="border-l-4 border-blue-600 pl-4">
        <div className="">
            <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1">Customer Feedback Analysis</h3>
            <p className="text-sm text-gray-600">Analyze reviews, surveys, and support tickets to understand customer sentiment and identify improvement areas across all touchpoints.</p>
        </div>
    </div>
    
    <div className="border-l-4 border-purple-600 pl-4">
        <div className="">
            <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1">Social Media Monitoring</h3>
            <p className="text-sm text-gray-600">Monitor brand sentiment across social platforms, track mentions, and analyze competitor positioning in real-time.</p>
        </div>
    </div>
    
    <div className="border-l-4 border-green-600 pl-4">
        <div className="">
            <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1">Document Processing</h3>
            <p className="text-sm text-gray-600">Extract insights from contracts, reports, and legal documents to automate classification and compliance checking.</p>
        </div>
    </div>
    
    <div className="border-l-4 border-orange-600 pl-4">
        <div className="">
            <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1">Market Research</h3>
            <p className="text-sm text-gray-600">Analyze market trends, consumer opinions, and competitive intelligence from unstructured data sources.</p>
        </div>
    </div>
    </div>
</CardContent>
                    ...
                    <div>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div 
                          ...
                          style={{ width: `${((analysisResult.sentiment.score + 1) / 2) * 100}%` }}
                        />
                      </div>
                    </div>
        ...
        <TabsContent value="quickstart" className="space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <span className="w-6 h-6 bg-blue-600 rounded-full text-white text-xs flex items-center justify-center">1</span>
                  Get API Key
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">Sign up and get your API key from the dashboard</p>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <span className="w-6 h-6 bg-blue-600 rounded-full text-white text-xs flex items-center justify-center">2</span>
                  Install SDK
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">Install our SDK in your preferred language</p>
                <Button variant="outline" className="w-full">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <span className="w-6 h-6 bg-blue-600 rounded-full text-white text-xs flex items-center justify-center">3</span>
                  Start Building
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">Make your first API call and start analyzing text</p>
                <Button variant="outline" className="w-full">
        ...
        <TabsContent value="docs" className="space-y-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">Complete API documentation with examples and parameters</p>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">Language-specific guides and best practices</p>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">Ready-to-use code snippets and sample applications</p>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">Setup guides and configuration options</p>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">Error codes, troubleshooting, and best practices</p>
              </CardContent>
            </Card>
            ...
            <Card className="cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">Step-by-step tutorials for common use cases</p>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
